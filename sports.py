...
# Returns a list of dicts. Each dict has game days for a different Pittsburgh team. The keys are days.
def get_sports_schedule():
    ...
    output_dicts.append(Steelers_home_games)
    ...
    output_dicts.append(Pens_home_games)
    ...
    output_dicts.append(Panthers_home_games)
